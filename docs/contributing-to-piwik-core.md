...
First, on your **6.x-dev** branch, pull changes from the main Piwik repository, nicknamed _upstream_:

```bash
git pull upstream 6.x-dev
```

Then, on your new branch (**bugfix** for this tutorial), merge with **6.x-dev**:
