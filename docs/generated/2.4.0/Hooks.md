...
_Defined in [Piwik/Plugins/API/API](https://github.com/piwik/piwik/blob/2.4.0/plugins/API/API.php) in line [145](https://github.com/piwik/piwik/blob/2.4.0/plugins/API/API.php#L145)_
...
_Defined in [Piwik/Plugins/SitesManager/API](https://github.com/piwik/piwik/blob/2.4.0/plugins/SitesManager/API.php) in line [628](https://github.com/piwik/piwik/blob/2.4.0/plugins/SitesManager/API.php#L628)_
...
_Defined in [Piwik/Plugins/SitesManager/API](https://github.com/piwik/piwik/blob/2.4.0/plugins/SitesManager/API.php) in line [683](https://github.com/piwik/piwik/blob/2.4.0/plugins/SitesManager/API.php#L683)_
...
_Defined in [Piwik/Plugins/UsersManager/Model](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/Model.php) in line [255](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/Model.php#L255)_
...
[CoreAdminHome::cleanupUser](https://github.com/piwik/piwik/blob/2.4.0/plugins/CoreAdminHome/CoreAdminHome.php#L31), [CoreVisualizations::deleteUser](https://github.com/piwik/piwik/blob/2.4.0/plugins/CoreVisualizations/CoreVisualizations.php#L39), [Dashboard::deleteDashboardLayout](https://github.com/piwik/piwik/blob/2.4.0/plugins/Dashboard/Dashboard.php#L225), [LanguagesManager::deleteUserLanguage](https://github.com/piwik/piwik/blob/2.4.0/plugins/LanguagesManager/LanguagesManager.php#L101), [ScheduledReports::deleteUserReport](https://github.com/piwik/piwik/blob/2.4.0/plugins/ScheduledReports/ScheduledReports.php#L527)


### UsersManager.getDefaultDates
_Defined in [Piwik/Plugins/UsersManager/Controller](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/Controller.php) in line [193](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/Controller.php#L193)_
...
_Defined in [Piwik/Plugins/UsersManager/API](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/API.php) in line [452](https://github.com/piwik/piwik/blob/2.4.0/plugins/UsersManager/API.php#L452)_
...
_Defined in [Piwik/View/ReportsByDimension](https://github.com/piwik/piwik/blob/2.4.0/core/View/ReportsByDimension.php) in line [99](https://github.com/piwik/piwik/blob/2.4.0/core/View/ReportsByDimension.php#L99)_
...
_Defined in [Piwik/ViewDataTable/Manager](https://github.com/piwik/piwik/blob/2.4.0/core/ViewDataTable/Manager.php) in line [83](https://github.com/piwik/piwik/blob/2.4.0/core/ViewDataTable/Manager.php#L83)_
...
[CoreVisualizations::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.4.0/plugins/CoreVisualizations/CoreVisualizations.php#L44), [ExampleVisualization::getAvailableVisualizations](https://github.com/piwik/piwik/blob/2.4.0/plugins/ExampleVisualization/ExampleVisualization.php#L25), [Goals::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.4.0/plugins/Goals/Goals.php#L119), [Insights::getAvailableVisualizations](https://github.com/piwik/piwik/blob/2.4.0/plugins/Insights/Insights.php#L27)


### ViewDataTable.configure
_Defined in [Piwik/Plugin/ViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/core/Plugin/ViewDataTable.php) in line [216](https://github.com/piwik/piwik/blob/2.4.0/core/Plugin/ViewDataTable.php#L216)_
...
[Actions::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Actions/Actions.php#L496), [CustomVariables::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/CustomVariables/CustomVariables.php#L165), [DBStats::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/DBStats/DBStats.php#L59), [DevicesDetection::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/DevicesDetection/DevicesDetection.php#L226), [Events::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Events/Events.php#L193), [Goals::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Goals/Goals.php#L474), [Provider::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Provider/Provider.php#L205), [Referrers::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Referrers/Referrers.php#L267), [UserCountry::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/UserCountry/UserCountry.php#L310), [UserSettings::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/UserSettings/UserSettings.php#L179), [VisitTime::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/VisitTime/VisitTime.php#L114), [VisitorInterest::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/VisitorInterest/VisitorInterest.php#L124)


### ViewDataTable.getDefaultType
_Defined in [Piwik/ViewDataTable/Factory](https://github.com/piwik/piwik/blob/2.4.0/core/ViewDataTable/Factory.php) in line [183](https://github.com/piwik/piwik/blob/2.4.0/core/ViewDataTable/Factory.php#L183)_
...
[DBStats::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/DBStats/DBStats.php#L46), [Live::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Live/Live.php#L56), [Referrers::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/Referrers/Referrers.php#L261), [UserSettings::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/UserSettings/UserSettings.php#L174), [VisitTime::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/VisitTime/VisitTime.php#L107), [VisitorInterest::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0/plugins/VisitorInterest/VisitorInterest.php#L118)
...
_Defined in [Piwik/WidgetsList](https://github.com/piwik/piwik/blob/2.4.0/core/WidgetsList.php) in line [80](https://github.com/piwik/piwik/blob/2.4.0/core/WidgetsList.php#L80)_
