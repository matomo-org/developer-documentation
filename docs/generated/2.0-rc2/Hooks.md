...
[DevicesDetection::parseMobileVisitData](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/DevicesDetection/DevicesDetection.php#L252), [Provider::enrichVisitWithProviderInfo](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Provider/Provider.php#L114), [UserCountry::enrichVisitWithLocation](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/UserCountry/UserCountry.php#L83)
...
[DBStats::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/DBStats/DBStats.php#L95), [Live::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Live/Live.php#L76), [Referrers::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Referrers/Referrers.php#L288), [UserSettings::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/UserSettings/UserSettings.php#L182), [VisitTime::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitTime/VisitTime.php#L127), [VisitorInterest::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitorInterest/VisitorInterest.php#L139)
...
_Defined in [Piwik/WidgetsList](https://github.com/piwik/piwik/blob/2.0-rc2/core/WidgetsList.php) in line [90](https://github.com/piwik/piwik/blob/2.0-rc2/core/WidgetsList.php#L90)_
...
[Actions::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Actions/Actions.php#L460), [CoreHome::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/CoreHome/CoreHome.php#L37), [CustomVariables::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/CustomVariables/CustomVariables.php#L48), [DevicesDetection::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/DevicesDetection/DevicesDetection.php#L170), [ExampleRssWidget::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/ExampleRssWidget/ExampleRssWidget.php#L37), [Goals::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Goals/Goals.php#L461), [Live::addWidget](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Live/Live.php#L59), [Provider::addWidget](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Provider/Provider.php#L95), [Referrers::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/Referrers/Referrers.php#L228), [SEO::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/SEO/SEO.php#L45), [UserCountry::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/UserCountry/UserCountry.php#L171), [UserSettings::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/UserSettings/UserSettings.php#L451), [VisitFrequency::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitFrequency/VisitFrequency.php#L61), [VisitTime::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitTime/VisitTime.php#L85), [VisitorInterest::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitorInterest/VisitorInterest.php#L105), [VisitsSummary::addWidgets](https://github.com/piwik/piwik/blob/2.0-rc2/plugins/VisitsSummary/VisitsSummary.php#L63)
