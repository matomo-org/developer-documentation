...
[CoreAdminHome::cleanupUser](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CoreAdminHome/CoreAdminHome.php#L37), [CoreVisualizations::deleteUser](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CoreVisualizations/CoreVisualizations.php#L39), [Dashboard::deleteDashboardLayout](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Dashboard/Dashboard.php#L213), [LanguagesManager::deleteUserLanguage](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/LanguagesManager/LanguagesManager.php#L101), [ScheduledReports::deleteUserReport](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/ScheduledReports/ScheduledReports.php#L546)


### UsersManager.getDefaultDates
_Defined in [Piwik/Plugins/UsersManager/Controller](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UsersManager/Controller.php) in line [193](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UsersManager/Controller.php#L193)_
...
_Defined in [Piwik/Plugins/UsersManager/API](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UsersManager/API.php) in line [447](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UsersManager/API.php#L447)_
...
_Defined in [Piwik/View/ReportsByDimension](https://github.com/piwik/piwik/blob/2.4.0-b2/core/View/ReportsByDimension.php) in line [99](https://github.com/piwik/piwik/blob/2.4.0-b2/core/View/ReportsByDimension.php#L99)_
...
_Defined in [Piwik/ViewDataTable/Manager](https://github.com/piwik/piwik/blob/2.4.0-b2/core/ViewDataTable/Manager.php) in line [83](https://github.com/piwik/piwik/blob/2.4.0-b2/core/ViewDataTable/Manager.php#L83)_
...
[CoreVisualizations::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CoreVisualizations/CoreVisualizations.php#L44), [ExampleVisualization::getAvailableVisualizations](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/ExampleVisualization/ExampleVisualization.php#L25), [Goals::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Goals/Goals.php#L116), [Insights::getAvailableVisualizations](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Insights/Insights.php#L30)


### ViewDataTable.configure
_Defined in [Piwik/Plugin/ViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/core/Plugin/ViewDataTable.php) in line [216](https://github.com/piwik/piwik/blob/2.4.0-b2/core/Plugin/ViewDataTable.php#L216)_
...
[Actions::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Actions/Actions.php#L524), [CustomVariables::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CustomVariables/CustomVariables.php#L174), [DBStats::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/DBStats/DBStats.php#L95), [DevicesDetection::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/DevicesDetection/DevicesDetection.php#L261), [Events::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Events/Events.php#L207), [Goals::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Goals/Goals.php#L495), [Provider::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Provider/Provider.php#L212), [Referrers::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Referrers/Referrers.php#L286), [UserCountry::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UserCountry/UserCountry.php#L338), [UserSettings::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UserSettings/UserSettings.php#L181), [VisitTime::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitTime/VisitTime.php#L123), [VisitorInterest::configureViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitorInterest/VisitorInterest.php#L134)


### ViewDataTable.getDefaultType
_Defined in [Piwik/ViewDataTable/Factory](https://github.com/piwik/piwik/blob/2.4.0-b2/core/ViewDataTable/Factory.php) in line [183](https://github.com/piwik/piwik/blob/2.4.0-b2/core/ViewDataTable/Factory.php#L183)_
...
[DBStats::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/DBStats/DBStats.php#L82), [Live::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Live/Live.php#L68), [Referrers::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Referrers/Referrers.php#L280), [UserSettings::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UserSettings/UserSettings.php#L176), [VisitTime::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitTime/VisitTime.php#L116), [VisitorInterest::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitorInterest/VisitorInterest.php#L128)
...
_Defined in [Piwik/WidgetsList](https://github.com/piwik/piwik/blob/2.4.0-b2/core/WidgetsList.php) in line [87](https://github.com/piwik/piwik/blob/2.4.0-b2/core/WidgetsList.php#L87)_
...
[Actions::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Actions/Actions.php#L465), [CoreHome::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CoreHome/CoreHome.php#L34), [CustomVariables::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/CustomVariables/CustomVariables.php#L46), [DevicesDetection::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/DevicesDetection/DevicesDetection.php#L163), [Events::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Events/Events.php#L36), [ExampleRssWidget::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/ExampleRssWidget/ExampleRssWidget.php#L34), [Goals::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Goals/Goals.php#L471), [Insights::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Insights/Insights.php#L35), [Live::addWidget](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Live/Live.php#L51), [Provider::addWidget](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Provider/Provider.php#L89), [Referrers::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/Referrers/Referrers.php#L232), [SEO::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/SEO/SEO.php#L41), [UserCountry::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UserCountry/UserCountry.php#L176), [UserSettings::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/UserSettings/UserSettings.php#L449), [VisitFrequency::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitFrequency/VisitFrequency.php#L56), [VisitTime::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitTime/VisitTime.php#L79), [VisitorInterest::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitorInterest/VisitorInterest.php#L100), [VisitsSummary::addWidgets](https://github.com/piwik/piwik/blob/2.4.0-b2/plugins/VisitsSummary/VisitsSummary.php#L64)
