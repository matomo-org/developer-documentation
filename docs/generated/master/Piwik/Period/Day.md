...
- [`__toString()`](#__tostring) &mdash; See [toString()](/api-reference/Piwik/Period/Day#tostring). Inherited from [`Period`](../../Piwik/Period.md)
...
See [toString()](/api-reference/Piwik/Period/Day#tostring).
