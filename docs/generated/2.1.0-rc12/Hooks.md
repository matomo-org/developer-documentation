...
[CoreUpdater::dispatch](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CoreUpdater/CoreUpdater.php#L112)
...
_Defined in [Piwik/Plugins/UsersManager/API](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/API.php) in line [347](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/API.php#L347)_
...
_Defined in [Piwik/Plugins/UsersManager/Model](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/Model.php) in line [265](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/Model.php#L265)_
...
[CoreAdminHome::cleanupUser](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CoreAdminHome/CoreAdminHome.php#L42), [Dashboard::deleteDashboardLayout](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Dashboard/Dashboard.php#L246), [LanguagesManager::deleteUserLanguage](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/LanguagesManager/LanguagesManager.php#L108), [ScheduledReports::deleteUserReport](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/ScheduledReports/ScheduledReports.php#L565)


### UsersManager.updateUser.end
_Defined in [Piwik/Plugins/UsersManager/API](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/API.php) in line [437](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UsersManager/API.php#L437)_
...
_Defined in [Piwik/View/ReportsByDimension](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/View/ReportsByDimension.php) in line [99](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/View/ReportsByDimension.php#L99)_
...
_Defined in [Piwik/ViewDataTable/Manager](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/ViewDataTable/Manager.php) in line [81](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/ViewDataTable/Manager.php#L81)_
...
[CoreVisualizations::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CoreVisualizations/CoreVisualizations.php#L36), [ExampleVisualization::getAvailableVisualizations](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/ExampleVisualization/ExampleVisualization.php#L25), [Goals::getAvailableDataTableVisualizations](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Goals/Goals.php#L119)


### ViewDataTable.configure
_Defined in [Piwik/Plugin/ViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/Plugin/ViewDataTable.php) in line [216](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/Plugin/ViewDataTable.php#L216)_
...
[Actions::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Actions/Actions.php#L517), [CustomVariables::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CustomVariables/CustomVariables.php#L132), [DBStats::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/DBStats/DBStats.php#L105), [DevicesDetection::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/DevicesDetection/DevicesDetection.php#L283), [Goals::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Goals/Goals.php#L539), [Provider::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Provider/Provider.php#L222), [Referrers::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Referrers/Referrers.php#L291), [UserCountry::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UserCountry/UserCountry.php#L352), [UserSettings::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UserSettings/UserSettings.php#L183), [VisitTime::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitTime/VisitTime.php#L132), [VisitorInterest::configureViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitorInterest/VisitorInterest.php#L142)


### ViewDataTable.getDefaultType
_Defined in [Piwik/ViewDataTable/Factory](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/ViewDataTable/Factory.php) in line [169](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/ViewDataTable/Factory.php#L169)_
...
[DBStats::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/DBStats/DBStats.php#L92), [Live::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Live/Live.php#L73), [Referrers::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Referrers/Referrers.php#L285), [UserSettings::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UserSettings/UserSettings.php#L178), [VisitTime::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitTime/VisitTime.php#L125), [VisitorInterest::getDefaultTypeViewDataTable](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitorInterest/VisitorInterest.php#L136)
...
_Defined in [Piwik/WidgetsList](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/WidgetsList.php) in line [87](https://github.com/piwik/piwik/blob/2.1.0-rc12/core/WidgetsList.php#L87)_
...
[Actions::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Actions/Actions.php#L457), [CoreHome::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CoreHome/CoreHome.php#L34), [CustomVariables::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/CustomVariables/CustomVariables.php#L45), [DevicesDetection::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/DevicesDetection/DevicesDetection.php#L180), [ExampleRssWidget::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/ExampleRssWidget/ExampleRssWidget.php#L34), [Goals::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Goals/Goals.php#L474), [Live::addWidget](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Live/Live.php#L56), [Provider::addWidget](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Provider/Provider.php#L93), [Referrers::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/Referrers/Referrers.php#L225), [SEO::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/SEO/SEO.php#L41), [UserCountry::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UserCountry/UserCountry.php#L172), [UserSettings::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/UserSettings/UserSettings.php#L447), [VisitFrequency::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitFrequency/VisitFrequency.php#L58), [VisitTime::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitTime/VisitTime.php#L82), [VisitorInterest::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitorInterest/VisitorInterest.php#L102), [VisitsSummary::addWidgets](https://github.com/piwik/piwik/blob/2.1.0-rc12/plugins/VisitsSummary/VisitsSummary.php#L60)
