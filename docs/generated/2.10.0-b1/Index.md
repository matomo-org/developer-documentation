...
- [`RankingQuery`](Piwik/RankingQuery.md) &mdash; *Class in namespace* `Piwik`- [`Registry`](Piwik/Registry.md) &mdash; *Class in namespace* `Piwik`- [`removeValue()`](Piwik/Settings/Setting.md#removevalue) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
