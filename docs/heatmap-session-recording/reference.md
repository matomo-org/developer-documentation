 ...
 * `sample_rate` How often a recording should be started. If you set 1000, the activities will be always recorded when someone views this page. If you set it to `100`, only in 10% of all page views the activities will be actually recorded.
