...
- It throws one of the following exceptions:
    - `Stmt_Namespace\Exception` &mdash; if the response cannot be saved to `$destinationPath`, if the HTTP response cannot be sent,
...
- It throws one of the following exceptions:
    - `Stmt_Namespace\Exception` &mdash; if the file already exists and we&#039;re starting a new download,
