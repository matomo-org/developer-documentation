...
- [`AverageEventValue`](Piwik/Plugins/Events/Columns/Metrics/AverageEventValue.md) &mdash; *Class in namespace* `Piwik\Plugins\Events\Columns\Metrics`- [`AbandonedRate`](Piwik/Plugins/Funnels/Columns/Metrics/AbandonedRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Funnels\Columns\Metrics`- [`AverageOrderRevenue`](Piwik/Plugins/Goals/Columns/Metrics/AverageOrderRevenue.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`AveragePrice`](Piwik/Plugins/Goals/Columns/Metrics/AveragePrice.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`AverageQuantity`](Piwik/Plugins/Goals/Columns/Metrics/AverageQuantity.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`AverageOrderRevenue`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/AverageOrderRevenue.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`AvgMediaCompletion`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/AvgMediaCompletion.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`AvgMediaLength`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/AvgMediaLength.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`AvgSecondsMetric`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/AvgSecondsMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`AvgTimeToPlay`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/AvgTimeToPlay.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`AvgTimeWatched`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/AvgTimeWatched.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`AttributionComparison`](Piwik/Plugins/MultiChannelConversionAttribution/Columns/Metrics/AttributionComparison.md) &mdash; *Class in namespace* `Piwik\Plugins\MultiChannelConversionAttribution\Columns\Metrics`- [`AveragePageLoadTime`](Piwik/Plugins/PagePerformance/Columns/Metrics/AveragePageLoadTime.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AveragePerformanceMetric`](Piwik/Plugins/PagePerformance/Columns/Metrics/AveragePerformanceMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeDomCompletion`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeDomCompletion.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeDomProcessing`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeDomProcessing.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeNetwork`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeNetwork.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeOnLoad`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeOnLoad.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeServer`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeServer.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`AverageTimeTransfer`](Piwik/Plugins/PagePerformance/Columns/Metrics/AverageTimeTransfer.md) &mdash; *Class in namespace* `Piwik\Plugins\PagePerformance\Columns\Metrics`- [`addLabelColumn()`](Piwik/RankingQuery.md#addlabelcolumn) &mdash; *Method in class* [`RankingQuery`](Piwik/RankingQuery.md)
...
- [`BounceRate`](Piwik/Plugins/AbTesting/Columns/Metrics/BounceRate.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`BounceRate`](Piwik/Plugins/Actions/Columns/Metrics/BounceRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Actions\Columns\Metrics`- [`Base`](Piwik/Plugins/Bandwidth/Columns/Metrics/Base.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`BounceRate`](Piwik/Plugins/CoreHome/Columns/Metrics/BounceRate.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreHome\Columns\Metrics`- [`beforeComputeSubtable()`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md#beforecomputesubtable) &mdash; *Method in class* [`EvolutionMetric`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md)
- [`BaseMetric`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/BaseMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`Browser`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/Browser.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md) &mdash; *Class in namespace* `Piwik\Plugins\TagManager\Template`- [`BaseTag`](Piwik/Plugins/TagManager/Template/Tag/BaseTag.md) &mdash; *Class in namespace* `Piwik\Plugins\TagManager\Template\Tag`- [`BaseTrigger`](Piwik/Plugins/TagManager/Template/Trigger/BaseTrigger.md) &mdash; *Class in namespace* `Piwik\Plugins\TagManager\Template\Trigger`- [`BaseVariable`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md) &mdash; *Class in namespace* `Piwik\Plugins\TagManager\Template\Variable`- [`boundSql()`](Piwik/Updater/Migration/Db/Factory.md#boundsql) &mdash; *Method in class* [`Factory`](Piwik/Updater/Migration/Db/Factory.md)
...
- [`ConversionRate`](Piwik/Plugins/AbTesting/Columns/Metrics/ConversionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`CohortTableColumn`](Piwik/Plugins/Cohorts/Columns/Metrics/CohortTableColumn.md) &mdash; *Class in namespace* `Piwik\Plugins\Cohorts\Columns\Metrics`- [`Config`](Piwik/Plugins/Cohorts/Visualizations/Cohorts/Config.md) &mdash; *Class in namespace* `Piwik\Plugins\Cohorts\Visualizations\Cohorts`- [`compute()`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md#compute) &mdash; *Method in class* [`AverageTimeOnSite`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md)
...
- [`ConversionRate`](Piwik/Plugins/Funnels/Columns/Metrics/ConversionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Funnels\Columns\Metrics`- [`ConversionEntryRate`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/ConversionEntryRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`ConversionPageRate`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/ConversionPageRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`ConversionRate`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/ConversionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`Conversions`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/Conversions.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`ConversionsAttrib`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/ConversionsAttrib.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`ConversionsEntry`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/ConversionsEntry.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`Config`](Piwik/Plugins/Live/Visualizations/VisitorLog/Config.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\Visualizations\VisitorLog`- [`Conversion`](Piwik/Plugins/MultiChannelConversionAttribution/Columns/Metrics/Conversion.md) &mdash; *Class in namespace* `Piwik\Plugins\MultiChannelConversionAttribution\Columns\Metrics`- [`Challenge`](Piwik/Plugins/Tour/Engagement/Challenge.md) &mdash; *Class in namespace* `Piwik\Plugins\Tour\Engagement`- [`clearCache()`](Piwik/Plugins/Tour/Engagement/Challenge.md#clearcache) &mdash; *Method in class* [`Challenge`](Piwik/Plugins/Tour/Engagement/Challenge.md)
...
- [`deleteMetadata()`](Piwik/DataTable.md#deletemetadata) &mdash; *Method in class* [`DataTable`](Piwik/DataTable.md)
...
- [`DetectedEffect`](Piwik/Plugins/AbTesting/Columns/Metrics/DetectedEffect.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`DownloadBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/DownloadBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`DevicePlugins`](Piwik/Plugins/DevicePlugins/DevicePlugins.md) &mdash; *Class in namespace* `Piwik\Plugins\DevicePlugins`- [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics`- [`Diagnostic`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResultItem`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResultItem.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`Device`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/Device.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`Daily`](Piwik/Scheduler/Schedule/Daily.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`$description`](Piwik/Settings/FieldConfig.md#$description) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`EcommerceOnlyEvolutionMetric`](Piwik/Plugins/MultiSites/Columns/Metrics/EcommerceOnlyEvolutionMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\MultiSites\Columns\Metrics`- [`ExitRate`](Piwik/Plugins/UsersFlow/Columns/Metrics/ExitRate.md) &mdash; *Class in namespace* `Piwik\Plugins\UsersFlow\Columns\Metrics`- [`execute()`](Piwik/RankingQuery.md#execute) &mdash; *Method in class* [`RankingQuery`](Piwik/RankingQuery.md)
...
- [`FieldAvgHesitationTime`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldAvgHesitationTime.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldAvgSizeConverted`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldAvgSizeConverted.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldAvgSizeOverall`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldAvgSizeOverall.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldAvgSizeSubmitted`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldAvgSizeSubmitted.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldAvgTimeSpent`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldAvgTimeSpent.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateAmendment`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateAmendment.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateCursors`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateCursors.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateDeletes`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateDeletes.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateLeftBlankConversion`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateLeftBlankConversion.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateLeftBlankSubmit`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateLeftBlankSubmit.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldRateRefocus`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldRateRefocus.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldSumHesitationTime`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldSumHesitationTime.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldSumInteractionUnsubmitted`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldSumInteractionUnsubmitted.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FieldSumTimeSpent`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FieldSumTimeSpent.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormAvgHesitationTime`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormAvgHesitationTime.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormAvgTimeSpent`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormAvgTimeSpent.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormAvgTimeToConversion`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormAvgTimeToConversion.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormAvgTimeToFirstSubmission`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormAvgTimeToFirstSubmission.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormRateConversion`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormRateConversion.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormRateResubmitter`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormRateResubmitter.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormRateStarters`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormRateStarters.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`FormRateSubmitter`](Piwik/Plugins/FormAnalytics/Columns/Metrics/FormRateSubmitter.md) &mdash; *Class in namespace* `Piwik\Plugins\FormAnalytics\Columns\Metrics`- [`filterActions()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#filteractions) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`FinishRate`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/FinishRate.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`FullscreenRate`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/FullscreenRate.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`forceViewDataTable()`](Piwik/Report/ReportWidgetConfig.md#forceviewdatatable) &mdash; *Method in class* [`ReportWidgetConfig`](Piwik/Report/ReportWidgetConfig.md)
- [`factory()`](Piwik/Scheduler/Schedule/Schedule.md#factory) &mdash; *Method in class* [`Schedule`](Piwik/Scheduler/Schedule/Schedule.md)
- [`FieldConfig`](Piwik/Settings/FieldConfig.md) &mdash; *Class in namespace* `Piwik\Settings`- [`$fullWidth`](Piwik/Settings/FieldConfig.md#$fullwidth) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`getId()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getid) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getParameters()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getparameters) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getCategory()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getcategory) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getSupportedContexts()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getsupportedcontexts) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getName()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getname) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getDescription()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getdescription) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getHelp()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#gethelp) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getOrder()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#getorder) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getIcon()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#geticon) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`getCategory()`](Piwik/Plugins/TagManager/Template/Tag/BaseTag.md#getcategory) &mdash; *Method in class* [`BaseTag`](Piwik/Plugins/TagManager/Template/Tag/BaseTag.md)
- [`getSupportedContexts()`](Piwik/Plugins/TagManager/Template/Tag/BaseTag.md#getsupportedcontexts) &mdash; *Method in class* [`BaseTag`](Piwik/Plugins/TagManager/Template/Tag/BaseTag.md)
- [`getCategory()`](Piwik/Plugins/TagManager/Template/Trigger/BaseTrigger.md#getcategory) &mdash; *Method in class* [`BaseTrigger`](Piwik/Plugins/TagManager/Template/Trigger/BaseTrigger.md)
- [`getSupportedContexts()`](Piwik/Plugins/TagManager/Template/Trigger/BaseTrigger.md#getsupportedcontexts) &mdash; *Method in class* [`BaseTrigger`](Piwik/Plugins/TagManager/Template/Trigger/BaseTrigger.md)
- [`getCategory()`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md#getcategory) &mdash; *Method in class* [`BaseVariable`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md)
- [`getSupportedContexts()`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md#getsupportedcontexts) &mdash; *Method in class* [`BaseVariable`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md)
...
- [`HitsWithBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/HitsWithBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`handleProfileVisit()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#handleprofilevisit) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`hasAdvancedSettings()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#hasadvancedsettings) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
...
- [`ImpressionRate`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/ImpressionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`isAvailable()`](Piwik/Plugins/MobileMessaging/SMSProvider.md#isavailable) &mdash; *Method in class* [`SMSProvider`](Piwik/Plugins/MobileMessaging/SMSProvider.md)
- [`isCustomTemplate()`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#iscustomtemplate) &mdash; *Method in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`isPreConfigured()`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md#ispreconfigured) &mdash; *Method in class* [`BaseVariable`](Piwik/Plugins/TagManager/Template/Variable/BaseVariable.md)
...
- [`Location`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/Location.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`
## M
...
- [`MaxBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/MaxBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`MinBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/MinBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`MenuTagManager`](Piwik/Plugins/TagManager/MenuTagManager.md) &mdash; *Class in namespace* `Piwik\Plugins\TagManager`- [`Monthly`](Piwik/Scheduler/Schedule/Monthly.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`MultiPair`](Piwik/Settings/FieldConfig/MultiPair.md) &mdash; *Class in namespace* [`Piwik\Settings\FieldConfig`](Piwik/Settings/FieldConfig)- [`Migration`](Piwik/Updater/Migration.md) &mdash; *Class in namespace* [`Piwik\Updater`](Piwik/Updater)- [`$metrics_documentation`](Piwik/ViewDataTable/Config.md#$metrics_documentation) &mdash; *Property in class* [`Config`](Piwik/ViewDataTable/Config.md)
...
- [`OverallBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/OverallBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`OperatingSystem`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/OperatingSystem.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`$overridableProperties`](Piwik/ViewDataTable/Config.md#$overridableproperties) &mdash; *Property in class* [`Config`](Piwik/ViewDataTable/Config.md)
...
- [`ProcessedMetric`](Piwik/Plugins/AbTesting/Columns/Metrics/ProcessedMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`PageviewBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/PageviewBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`ProceededRate`](Piwik/Plugins/Funnels/Columns/Metrics/ProceededRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Funnels\Columns\Metrics`- [`ProductConversionRate`](Piwik/Plugins/Goals/Columns/Metrics/ProductConversionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`ProfileSummaryProvider`](Piwik/Plugins/Live/ProfileSummaryProvider.md) &mdash; *Class in namespace* `Piwik\Plugins\Live`- [`ProfileSummaryAbstract`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\ProfileSummary`- [`provideActionsForVisit()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#provideactionsforvisit) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`PlayRate`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/PlayRate.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`Proceeded`](Piwik/Plugins/UsersFlow/Columns/Metrics/Proceeded.md) &mdash; *Class in namespace* `Piwik\Plugins\UsersFlow\Columns\Metrics`- [`ProceededRate`](Piwik/Plugins/UsersFlow/Columns/Metrics/ProceededRate.md) &mdash; *Class in namespace* `Piwik\Plugins\UsersFlow\Columns\Metrics`- [`partitionResultIntoMultipleGroups()`](Piwik/RankingQuery.md#partitionresultintomultiplegroups) &mdash; *Method in class* [`RankingQuery`](Piwik/RankingQuery.md)
...
- [`RemainingVisitors`](Piwik/Plugins/AbTesting/Columns/Metrics/RemainingVisitors.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`runDiagnostics()`](Piwik/Plugins/Diagnostics/DiagnosticService.md#rundiagnostics) &mdash; *Method in class* [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md)
- [`Revenue`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/Revenue.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenueAttrib`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/RevenueAttrib.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenueEntry`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/RevenueEntry.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenuePerEntry`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/RevenuePerEntry.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenuePerVisit`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/RevenuePerVisit.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenuePerVisit`](Piwik/Plugins/Goals/Columns/Metrics/RevenuePerVisit.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`render()`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md#render) &mdash; *Method in class* [`ProfileSummaryAbstract`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md)
...
- [`Revenue`](Piwik/Plugins/MultiChannelConversionAttribution/Columns/Metrics/Revenue.md) &mdash; *Class in namespace* `Piwik\Plugins\MultiChannelConversionAttribution\Columns\Metrics`- [`$RESERVED_SETTING_NAMES`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#$reserved_setting_names) &mdash; *Property in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
...
- [`SignificanceRate`](Piwik/Plugins/AbTesting/Columns/Metrics/SignificanceRate.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`SumBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/SumBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`singleResult()`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md#singleresult) &mdash; *Method in class* [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md)
...
- [`SessionTime`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/SessionTime.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`setProfile()`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md#setprofile) &mdash; *Method in class* [`ProfileSummaryAbstract`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md)
- [`SegmentPlayRate`](Piwik/Plugins/MediaAnalytics/Columns/Metrics/SegmentPlayRate.md) &mdash; *Class in namespace* `Piwik\Plugins\MediaAnalytics\Columns\Metrics`- [`SMSProvider`](Piwik/Plugins/MobileMessaging/SMSProvider.md) &mdash; *Class in namespace* `Piwik\Plugins\MobileMessaging`- [`sendSMS()`](Piwik/Plugins/MobileMessaging/SMSProvider.md#sendsms) &mdash; *Method in class* [`SMSProvider`](Piwik/Plugins/MobileMessaging/SMSProvider.md)
...
- [`TotalMoney`](Piwik/Plugins/AbTesting/Columns/Metrics/TotalMoney.md) &mdash; *Class in namespace* `Piwik\Plugins\AbTesting\Columns\Metrics`- [`TrackerUpdater`](Piwik/Plugins/CustomJsTracker/TrackerUpdater.md) &mdash; *Class in namespace* `Piwik\Plugins\CustomJsTracker`- [`TimeOnPage`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/TimeOnPage.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`TimeOnSite`](Piwik/Plugins/HeatmapSessionRecording/Columns/Metrics/TimeOnSite.md) &mdash; *Class in namespace* `Piwik\Plugins\HeatmapSessionRecording\Columns\Metrics`- [`TreemapConfig`](Piwik/Plugins/TreemapVisualization/TreemapConfig.md) &mdash; *Class in namespace* `Piwik\Plugins\TreemapVisualization`- [`Task`](Piwik/Scheduler/Task.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`$transform`](Piwik/Settings/FieldConfig.md#$transform) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
