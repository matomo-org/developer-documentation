...
- The Matomo instance translates all form text to into the chosen language, or the browser language if `language=auto` is used and returns the resulting JavaScript.
