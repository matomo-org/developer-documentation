...
* `disableBrowserFeatureDetection()` - Disable the browser feature detection, this can be used to limit browser fingerprinting due to privacy regulations in some regions. [Learn more about feature detection](https://matomo.org/faq/how-do-i-disable-browser-feature-detection-completely/)
 * `enableBrowserFeatureDetection()` - Enable the browser feature detection [Learn how browser feature detection is used](https://matomo.org/faq/general/how-is-the-visitor-config_id-processed/)  
