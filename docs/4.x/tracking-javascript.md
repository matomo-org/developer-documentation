...
* `disableBrowserFeatureDetection()` - Disable the browser feature detection, this is used to disable browser fingerprint due to privacy policy in some regions. [Learn more about feature detection](https://matomo.org/faq/how-do-i-disable-browser-feature-detection-completely/)
