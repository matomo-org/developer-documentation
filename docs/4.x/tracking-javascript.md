...
* `disableBrowserFeatureDetection()` - Disable the browser feature detection [Learn more about feature detection](https://matomo.org/faq/how-do-i-disable-browser-feature-detection-completely/)
