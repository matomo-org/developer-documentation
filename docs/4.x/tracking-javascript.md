...
* `disableBrowserFeatureDetection()` - Disable the browser feature detection, this is used to disable browser fingerprinting due to privacy regulations in some regions. [Learn more about feature detection](https://matomo.org/faq/how-do-i-disable-browser-feature-detection-completely/)
