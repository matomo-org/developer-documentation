...
*   **idSite**
    ...
    *   if you want to get data for all websites, set _idSite=all_ (this is only supported by some API methds and it might not work should eg dimensions, goals, or segments only be available for specific sites)
