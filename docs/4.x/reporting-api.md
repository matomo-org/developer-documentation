...
*   **translateColumnNames**; if set to 1, column names in report output will be translated to the current user's language (the language is set in the user's personal settings).
