...
- [`$onlineGuideUrl`](#$onlineguideurl) &mdash; URL linking to an online guide for this report (or plugin).
...
Adds a related report to the [$related_reports](/api-reference/Piwik/ViewDataTable/Config#$related_reports) property. If the report
...
Adds several related reports to the [$related_reports](/api-reference/Piwik/ViewDataTable/Config#$related_reports) property. If
