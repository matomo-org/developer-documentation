...
- [`Scheduler`](Piwik/Scheduler/Scheduler.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`Segment`](Piwik/Segment.md) &mdash; *Class in namespace* `Piwik`- [`SettingsPiwik`](Piwik/SettingsPiwik.md) &mdash; *Class in namespace* `Piwik`- [`SettingsServer`](Piwik/SettingsServer.md) &mdash; *Class in namespace* `Piwik`- [`SystemConfigSetting`](Piwik/Settings/Plugin/SystemConfigSetting.md) &mdash; *Class in namespace* `Piwik\Settings\Plugin`- [`SystemSetting`](Piwik/Settings/Plugin/SystemSetting.md) &mdash; *Class in namespace* `Piwik\Settings\Plugin`- [`Setting`](Piwik/Settings/Setting.md) &mdash; *Class in namespace* `Piwik\Settings`- [`setConfigureCallback()`](Piwik/Settings/Setting.md#setconfigurecallback) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
