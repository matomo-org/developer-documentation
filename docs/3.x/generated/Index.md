...
- [`GoalSpecificProcessedMetric`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecificProcessedMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`getAllProfileSummaryClasses()`](Piwik/Plugins/Live/ProfileSummaryProvider.md#getallprofilesummaryclasses) &mdash; *Method in class* [`ProfileSummaryProvider`](Piwik/Plugins/Live/ProfileSummaryProvider.md)
