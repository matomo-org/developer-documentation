...
- [`checkWillSucceed()`](Piwik/Plugins/CustomPiwikJs/TrackerUpdater.md#checkwillsucceed) &mdash; *Method in class* [`TrackerUpdater`](Piwik/Plugins/CustomPiwikJs/TrackerUpdater.md)
...
- [`EvolutionMetric`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreHome\Columns\Metrics`- [`execute()`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md#execute) &mdash; *Method in class* [`Diagnostic`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md)
...
- [`Item`](Piwik/Plugins/CoreHome/SystemSummary/Item.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreHome\SystemSummary`- [`ImportantVisits`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\ProfileSummary`- [`initProfile()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#initprofile) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`ProfileSummaryAbstract`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\ProfileSummary`- [`provideActionsForVisit()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#provideactionsforvisit) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`render()`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md#render) &mdash; *Method in class* [`ImportantVisits`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md)
...
- [`RankingQuery`](Piwik/RankingQuery.md) &mdash; *Class in namespace* `Piwik`- [`Registry`](Piwik/Registry.md) &mdash; *Class in namespace* `Piwik`- [`ReportWidgetConfig`](Piwik/Report/ReportWidgetConfig.md) &mdash; *Class in namespace* `Piwik\Report`- [`ReportWidgetFactory`](Piwik/Report/ReportWidgetFactory.md) &mdash; *Class in namespace* `Piwik\Report`- [`rescheduleTask()`](Piwik/Scheduler/Scheduler.md#rescheduletask) &mdash; *Method in class* [`Scheduler`](Piwik/Scheduler/Scheduler.md)
...
- [`TrackerUpdater`](Piwik/Plugins/CustomPiwikJs/TrackerUpdater.md) &mdash; *Class in namespace* `Piwik\Plugins\CustomPiwikJs`- [`Task`](Piwik/Scheduler/Task.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`$transform`](Piwik/Settings/FieldConfig.md#$transform) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`VisitDimension`](Piwik/Plugin/Dimension/VisitDimension.md) &mdash; *Class in namespace* `Piwik\Plugin\Dimension`- [`ViewDataTable`](Piwik/Plugin/ViewDataTable.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`Visualization`](Piwik/Plugin/Visualization.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`VisitScopeSummary`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md) &mdash; *Class in namespace* `Piwik\Plugins\CustomVariables\ProfileSummary`- [`Visitor`](Piwik/Plugins/Live/Visitor.md) &mdash; *Class in namespace* `Piwik\Plugins\Live`- [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md) &mdash; *Class in namespace* `Piwik\Plugins\Live`- [`verifyCredential()`](Piwik/Plugins/MobileMessaging/SMSProvider.md#verifycredential) &mdash; *Method in class* [`SMSProvider`](Piwik/Plugins/MobileMessaging/SMSProvider.md)
