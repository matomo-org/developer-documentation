...
- [`Advertising`](Piwik/PiwikPro/Advertising.md) &mdash; *Class in namespace* `Piwik\PiwikPro`- [`arePiwikProAdsEnabled()`](Piwik/PiwikPro/Advertising.md#arepiwikproadsenabled) &mdash; *Method in class* [`Advertising`](Piwik/PiwikPro/Advertising.md)
- [`addPromoCampaignParametersToUrl()`](Piwik/PiwikPro/Advertising.md#addpromocampaignparameterstourl) &mdash; *Method in class* [`Advertising`](Piwik/PiwikPro/Advertising.md)
...
- [`ConversionDimension`](Piwik/Plugin/Dimension/ConversionDimension.md) &mdash; *Class in namespace* `Piwik\Plugin\Dimension`- [`configureTopMenu()`](Piwik/Plugin/Menu.md#configuretopmenu) &mdash; *Method in class* [`Menu`](Piwik/Plugin/Menu.md)
...
- [`ContentsByDimension`](Piwik/Plugins/Contents/Widgets/ContentsByDimension.md) &mdash; *Class in namespace* `Piwik\Plugins\Contents\Widgets`- [`compute()`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md#compute) &mdash; *Method in class* [`AverageTimeOnSite`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md)
...
- [`configureField()`](Piwik/Settings/Setting.md#configurefield) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
...
- [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics`- [`Diagnostic`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResultItem`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResultItem.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`Daily`](Piwik/Scheduler/Schedule/Daily.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`$description`](Piwik/Settings/FieldConfig.md#$description) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`EventsByDimension`](Piwik/Plugins/Events/Widgets/EventsByDimension.md) &mdash; *Class in namespace* `Piwik\Plugins\Events\Widgets`- [`execute()`](Piwik/RankingQuery.md#execute) &mdash; *Method in class* [`RankingQuery`](Piwik/RankingQuery.md)
...
- [`getImmediateChildPeriodLabel()`](Piwik/Period.md#getimmediatechildperiodlabel) &mdash; *Method in class* [`Period`](Piwik/Period.md)
...
- [`getPromoUrlForCloud()`](Piwik/PiwikPro/Advertising.md#getpromourlforcloud) &mdash; *Method in class* [`Advertising`](Piwik/PiwikPro/Advertising.md)
- [`getPromoUrlForOnPremises()`](Piwik/PiwikPro/Advertising.md#getpromourlforonpremises) &mdash; *Method in class* [`Advertising`](Piwik/PiwikPro/Advertising.md)
...
- [`getSetting()`](Piwik/Settings/Settings.md#getsetting) &mdash; *Method in class* [`Settings`](Piwik/Settings/Settings.md)
...
- [`get()`](Piwik/Widget/WidgetsList.md#get) &mdash; *Method in class* [`WidgetsList`](Piwik/Widget/WidgetsList.md)
...
- [`Index`](Piwik/Plugins/VisitsSummary/Widgets/Index.md) &mdash; *Class in namespace* `Piwik\Plugins\VisitsSummary\Widgets`- [`isRegistered()`](Piwik/Registry.md#isregistered) &mdash; *Method in class* [`Registry`](Piwik/Registry.md)
...
- [`ProductsByDimension`](Piwik/Plugins/Ecommerce/Widgets/ProductsByDimension.md) &mdash; *Class in namespace* `Piwik\Plugins\Ecommerce\Widgets`- [`partitionResultIntoMultipleGroups()`](Piwik/RankingQuery.md#partitionresultintomultiplegroups) &mdash; *Method in class* [`RankingQuery`](Piwik/RankingQuery.md)
...
- [`setDatabaseObject()`](Piwik/Db.md#setdatabaseobject) &mdash; *Method in class* [`Db`](Piwik/Db.md)
...
- [`setSingletonInstance()`](Piwik/Plugin/API.md#setsingletoninstance) &mdash; *Method in class* [`API`](Piwik/Plugin/API.md)
...
- [`Scheduler`](Piwik/Scheduler/Scheduler.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`Segment`](Piwik/Segment.md) &mdash; *Class in namespace* `Piwik`- [`SettingsPiwik`](Piwik/SettingsPiwik.md) &mdash; *Class in namespace* `Piwik`- [`SettingsServer`](Piwik/SettingsServer.md) &mdash; *Class in namespace* `Piwik`- [`SystemSetting`](Piwik/Settings/Plugin/SystemSetting.md) &mdash; *Class in namespace* `Piwik\Settings\Plugin`- [`Setting`](Piwik/Settings/Setting.md) &mdash; *Class in namespace* `Piwik\Settings`- [`setConfigureCallback()`](Piwik/Settings/Setting.md#setconfigurecallback) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
- [`setDefaultValue()`](Piwik/Settings/Setting.md#setdefaultvalue) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
- [`setStorage()`](Piwik/Settings/Setting.md#setstorage) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
...
- [`Task`](Piwik/Scheduler/Task.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`$transform`](Piwik/Settings/FieldConfig.md#$transform) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`unsetInstance()`](Piwik/Plugin/API.md#unsetinstance) &mdash; *Method in class* [`API`](Piwik/Plugin/API.md)
- [`unsetAllInstances()`](Piwik/Plugin/API.md#unsetallinstances) &mdash; *Method in class* [`API`](Piwik/Plugin/API.md)
...
- [`__construct()`](Piwik/PiwikPro/Advertising.md#__construct) &mdash; *Method in class* [`Advertising`](Piwik/PiwikPro/Advertising.md)
