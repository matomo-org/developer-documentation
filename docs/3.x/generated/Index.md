...
- [`addSegment()`](Piwik/Columns/Dimension.md#addsegment) &mdash; *Method in class* [`Dimension`](Piwik/Columns/Dimension.md)
...
- [`addItem()`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md#additem) &mdash; *Method in class* [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md)
...
- [`CurrencyDataProvider`](Piwik/Intl/Data/Provider/CurrencyDataProvider.md) &mdash; *Class in namespace* `Piwik\Intl\Data\Provider`- [`createAttachment()`](Piwik/Mail.md#createattachment) &mdash; *Method in class* [`Mail`](Piwik/Mail.md)
...
- [`DimensionMetricFactory`](Piwik/Columns/DimensionMetricFactory.md) &mdash; *Class in namespace* `Piwik\Columns`- [`Discriminator`](Piwik/Columns/Discriminator.md) &mdash; *Class in namespace* `Piwik\Columns`- [`destroy()`](Piwik/Common.md#destroy) &mdash; *Method in class* [`Common`](Piwik/Common.md)
...
- [`DevicePlugins`](Piwik/Plugins/DevicePlugins/DevicePlugins.md) &mdash; *Class in namespace* `Piwik\Plugins\DevicePlugins`- [`DevicesSummary`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md) &mdash; *Class in namespace* `Piwik\Plugins\DevicesDetection\ProfileSummary`- [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics`- [`Diagnostic`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResultItem`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResultItem.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`Daily`](Piwik/Scheduler/Schedule/Daily.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`$description`](Piwik/Settings/FieldConfig.md#$description) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
...
- [`EcommerceSummary`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md) &mdash; *Class in namespace* `Piwik\Plugins\Ecommerce\ProfileSummary`- [`extendVisitorDetails()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#extendvisitordetails) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`Factory`](Piwik/Updater/Migration/Db/Factory.md) &mdash; *Class in namespace* [`Piwik\Updater\Migration\Db`](Piwik/Updater/Migration/Db)- [`Factory`](Piwik/Updater/Migration/Factory.md) &mdash; *Class in namespace* [`Piwik\Updater\Migration`](Piwik/Updater/Migration)- [`Factory`](Piwik/Updater/Migration/Plugin/Factory.md) &mdash; *Class in namespace* `Piwik\Updater\Migration\Plugin`- [`$footer_icons`](Piwik/ViewDataTable/Config.md#$footer_icons) &mdash; *Property in class* [`Config`](Piwik/ViewDataTable/Config.md)
...
- [`getName()`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md#getname) &mdash; *Method in class* [`VisitScopeSummary`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md)
- [`getOrder()`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md#getorder) &mdash; *Method in class* [`VisitScopeSummary`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md)
...
- [`getName()`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md#getname) &mdash; *Method in class* [`DevicesSummary`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md)
- [`getOrder()`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md#getorder) &mdash; *Method in class* [`DevicesSummary`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md)
...
- [`getName()`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md#getname) &mdash; *Method in class* [`EcommerceSummary`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md)
- [`getOrder()`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md#getorder) &mdash; *Method in class* [`EcommerceSummary`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md)
...
- [`getName()`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md#getname) &mdash; *Method in class* [`ImportantVisits`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md)
- [`getOrder()`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md#getorder) &mdash; *Method in class* [`ImportantVisits`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md)
...
- [`getName()`](Piwik/Plugins/Live/ProfileSummary/Summary.md#getname) &mdash; *Method in class* [`Summary`](Piwik/Plugins/Live/ProfileSummary/Summary.md)
- [`getOrder()`](Piwik/Plugins/Live/ProfileSummary/Summary.md#getorder) &mdash; *Method in class* [`Summary`](Piwik/Plugins/Live/ProfileSummary/Summary.md)
...
- [`getName()`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md#getname) &mdash; *Method in class* [`LocationSummary`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md)
- [`getOrder()`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md#getorder) &mdash; *Method in class* [`LocationSummary`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md)
...
- [`LocationSummary`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md) &mdash; *Class in namespace* `Piwik\Plugins\UserCountry\ProfileSummary`
## M
...
- [`Numeric`](Piwik/Plugins/CoreVisualizations/Metrics/Formatter/Numeric.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreVisualizations\Metrics\Formatter`- [`$no_data_message`](Piwik/ViewDataTable/Config.md#$no_data_message) &mdash; *Property in class* [`Config`](Piwik/ViewDataTable/Config.md)
...
- [`render()`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md#render) &mdash; *Method in class* [`VisitScopeSummary`](Piwik/Plugins/CustomVariables/ProfileSummary/VisitScopeSummary.md)
- [`render()`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md#render) &mdash; *Method in class* [`DevicesSummary`](Piwik/Plugins/DevicesDetection/ProfileSummary/DevicesSummary.md)
...
- [`render()`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md#render) &mdash; *Method in class* [`EcommerceSummary`](Piwik/Plugins/Ecommerce/ProfileSummary/EcommerceSummary.md)
- [`Revenue`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/Revenue.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenuePerVisit`](Piwik/Plugins/Goals/Columns/Metrics/GoalSpecific/RevenuePerVisit.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics\GoalSpecific`- [`RevenuePerVisit`](Piwik/Plugins/Goals/Columns/Metrics/RevenuePerVisit.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`render()`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md#render) &mdash; *Method in class* [`ImportantVisits`](Piwik/Plugins/Live/ProfileSummary/ImportantVisits.md)
...
- [`render()`](Piwik/Plugins/Live/ProfileSummary/Summary.md#render) &mdash; *Method in class* [`Summary`](Piwik/Plugins/Live/ProfileSummary/Summary.md)
...
- [`render()`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md#render) &mdash; *Method in class* [`LocationSummary`](Piwik/Plugins/UserCountry/ProfileSummary/LocationSummary.md)
- [`ReturningMetric`](Piwik/Plugins/VisitFrequency/Columns/Metrics/ReturningMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\VisitFrequency\Columns\Metrics`- [`RankingQuery`](Piwik/RankingQuery.md) &mdash; *Class in namespace* `Piwik`- [`Registry`](Piwik/Registry.md) &mdash; *Class in namespace* `Piwik`- [`ReportWidgetConfig`](Piwik/Report/ReportWidgetConfig.md) &mdash; *Class in namespace* `Piwik\Report`- [`ReportWidgetFactory`](Piwik/Report/ReportWidgetFactory.md) &mdash; *Class in namespace* `Piwik\Report`- [`rescheduleTask()`](Piwik/Scheduler/Scheduler.md#rescheduletask) &mdash; *Method in class* [`Scheduler`](Piwik/Scheduler/Scheduler.md)
...
- [`Summary`](Piwik/Plugins/Live/ProfileSummary/Summary.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\ProfileSummary`- [`setDetails()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#setdetails) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`SpecificTime`](Piwik/Scheduler/Schedule/SpecificTime.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`Scheduler`](Piwik/Scheduler/Scheduler.md) &mdash; *Class in namespace* `Piwik\Scheduler`- [`Segment`](Piwik/Segment.md) &mdash; *Class in namespace* `Piwik`- [`SettingsPiwik`](Piwik/SettingsPiwik.md) &mdash; *Class in namespace* `Piwik`- [`SettingsServer`](Piwik/SettingsServer.md) &mdash; *Class in namespace* `Piwik`- [`SystemConfigSetting`](Piwik/Settings/Plugin/SystemConfigSetting.md) &mdash; *Class in namespace* `Piwik\Settings\Plugin`- [`SystemSetting`](Piwik/Settings/Plugin/SystemSetting.md) &mdash; *Class in namespace* `Piwik\Settings\Plugin`- [`Setting`](Piwik/Settings/Setting.md) &mdash; *Class in namespace* `Piwik\Settings`- [`setDefaultValue()`](Piwik/Settings/Setting.md#setdefaultvalue) &mdash; *Method in class* [`Setting`](Piwik/Settings/Setting.md)
