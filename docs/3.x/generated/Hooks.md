...
[CoreHome::addStylesheets](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L70)
...
[CoreHome::filterMergedJavaScripts](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L109)
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [584](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L584)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1757](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1757)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [391](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L391)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [345](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L345)*
...
*Defined in [Piwik/Columns/Dimension](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/Dimension.php) in line [784](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/Dimension.php#L784)*
...
*Defined in [Piwik/Columns/Dimension](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/Dimension.php) in line [808](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/Dimension.php#L808)*
...
*Defined in [Piwik/Plugins/Live/Model](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/Model.php) in line [387](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/Model.php#L387)*
...
[CoreHome::initAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L76), [Login::onInitAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L83)
...
*Defined in [Piwik/Plugins/Referrers/Columns/Base](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Referrers/Columns/Base.php) in line [239](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Referrers/Columns/Base.php#L239)*
...
*Defined in [Piwik/Plugins/Referrers/Columns/Base](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Referrers/Columns/Base.php) in line [290](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Referrers/Columns/Base.php#L290)*
