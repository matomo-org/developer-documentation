...
*Defined in [Piwik/Plugins/API/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/API/API.php) in line [653](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/API/API.php#L653)*
...
[Live::getPagesComparisonsDisabledFor](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/Live.php#L41), [MultiSites::getPagesComparisonsDisabledFor](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MultiSites/MultiSites.php#L29), [Referrers::getPagesComparisonsDisabledFor](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Referrers/Referrers.php#L66), [Transitions::getPagesComparisonsDisabledFor](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Transitions/Transitions.php#L29), [UserCountryMap::getPagesComparisonsDisabledFor](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UserCountryMap/UserCountryMap.php#L40)
...
*Defined in [Piwik/Archive/ArchiveInvalidator](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Archive/ArchiveInvalidator.php) in line [247](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Archive/ArchiveInvalidator.php#L247)*
...
[CoreHome::addStylesheets](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L64)
...
[CoreHome::filterMergedJavaScripts](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L103)
...
[Installation::dispatch](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Installation/Installation.php#L101)
...
*Defined in [Piwik/Console](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php) in line [183](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php#L183)*
...
*Defined in [Piwik/Plugin/ControllerAdmin](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ControllerAdmin.php) in line [356](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ControllerAdmin.php#L356)*
...
*Defined in [Piwik/Config](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Config.php) in line [440](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Config.php#L440)*
...
*Defined in [Piwik/Plugins/CoreAdminHome/CustomLogo](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreAdminHome/CustomLogo.php) in line [235](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreAdminHome/CustomLogo.php#L235)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [519](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L519)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [509](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L509)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [576](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L576)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1200](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1200)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1604](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1604)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [383](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L383)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [337](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L337)*
...
*Defined in [Piwik/Http](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Http.php) in line [704](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Http.php#L704)*
...
[PrivacyManager::installationFormInit](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/PrivacyManager.php#L243)
...
*Defined in [Piwik/Mail](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Mail.php) in line [215](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Mail.php#L215)*
...
*Defined in [Piwik/Plugin/Manager](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php) in line [697](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php#L697)*
...
*Defined in [Piwik/Plugin/Manager](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php) in line [529](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php#L529)*
...
*Defined in [Piwik/Plugin/Manager](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php) in line [1362](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php#L1362)*
...
*Defined in [Piwik/Plugin/Manager](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php) in line [618](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Manager.php#L618)*
...
[CoreHome::initAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L70), [Login::onInitAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L83)
...
*Defined in [Piwik/Console](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php) in line [293](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php#L293)*
...
[SegmentEditor::getKnownSegmentsToArchiveAllSites](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SegmentEditor/SegmentEditor.php#L70)
...
[SegmentEditor::getKnownSegmentsToArchiveForSite](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SegmentEditor/SegmentEditor.php#L82)
...
*Defined in [Piwik/Plugins/SitesManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/API.php) in line [820](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/API.php#L820)*
...
*Defined in [Piwik/Plugins/SitesManager/SitesManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php) in line [130](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L130)*
...
*Defined in [Piwik/Plugins/Tour/Engagement/Challenges](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Tour/Engagement/Challenges.php) in line [112](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Tour/Engagement/Challenges.php#L112)*
...
[Goals::fetchGoalsFromDb](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L354), [UsersManager::recordAdminUsersInCache](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L94)
...
*Defined in [Piwik/Plugins/QueuedTracking/Commands/Process](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/QueuedTracking/Commands/Process.php) in line [83](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/QueuedTracking/Commands/Process.php#L83)*
...
*Defined in [Piwik/Tracker](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker.php) in line [117](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker.php#L117)*
...
*Defined in [Piwik/Plugins/TwoFactorAuth/Controller](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/TwoFactorAuth/Controller.php) in line [219](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/TwoFactorAuth/Controller.php#L219)*
...
[Login::noAccess](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L160)
...
*Defined in [Piwik/Plugins/UsersManager/UsersManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php) in line [208](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L208)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [1113](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L1113)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [958](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L958)*
...
*Defined in [Piwik/Plugin/ViewDataTable](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ViewDataTable.php) in line [269](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ViewDataTable.php#L269)*
...
*Defined in [Piwik/Plugin/ViewDataTable](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ViewDataTable.php) in line [311](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/ViewDataTable.php#L311)*
...
*Defined in [Piwik/Plugin/Visualization](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Visualization.php) in line [777](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Plugin/Visualization.php#L777)*
