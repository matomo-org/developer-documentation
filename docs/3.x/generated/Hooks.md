...
[Goals::getReportMetadataEnd](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L227)
...
[Login::ApiRequestAuthenticate](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L91)
...
*Defined in [Piwik/ArchiveProcessor/PluginsArchiver](https://github.com/matomo-org/matomo/blob/3.x-dev/core/ArchiveProcessor/PluginsArchiver.php) in line [87](https://github.com/matomo-org/matomo/blob/3.x-dev/core/ArchiveProcessor/PluginsArchiver.php#L87)*
...
*Defined in [Piwik/ArchiveProcessor/PluginsArchiver](https://github.com/matomo-org/matomo/blob/3.x-dev/core/ArchiveProcessor/PluginsArchiver.php) in line [324](https://github.com/matomo-org/matomo/blob/3.x-dev/core/ArchiveProcessor/PluginsArchiver.php#L324)*
...
[Dashboard::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Dashboard/Dashboard.php#L81), [Goals::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L164)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [326](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L326)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [554](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L554)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [571](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L571)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [498](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L498)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [488](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L488)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [550](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L550)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1168](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1168)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1567](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1567)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [303](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L303)*
...
*Defined in [Piwik/Plugins/Goals/Goals](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php) in line [320](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L320)*
...
[PrivacyManager::installationFormInit](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/PrivacyManager.php#L235)
...
[PrivacyManager::installationFormSubmit](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/PrivacyManager.php#L258)
...
*Defined in [Piwik/Plugins/Live/Model](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/Model.php) in line [182](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/Model.php#L182)*
...
*Defined in [Piwik/Plugins/Live/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/API.php) in line [254](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Live/API.php#L254)*
...
*Defined in [Piwik/Plugins/Login/Controller](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Controller.php) in line [376](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Controller.php#L376)*
...
*Defined in [Piwik/Mail](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Mail.php) in line [147](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Mail.php#L147)*
...
*Defined in [Piwik/Columns/MetricsList](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php) in line [142](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php#L142)*
...
[CoreHome::addComputedMetrics](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L71), [Ecommerce::addComputedMetrics](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Ecommerce/Ecommerce.php#L33), [Goals::addComputedMetrics](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L103)


### Metric.addMetrics

*Defined in [Piwik/Columns/MetricsList](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php) in line [118](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php#L118)*
...
[Goals::addMetrics](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L117)


### Metric.filterMetrics

*Defined in [Piwik/Columns/MetricsList](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php) in line [156](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Columns/MetricsList.php#L156)*
...
[CustomAlerts::removePhoneNumberFromAllAlerts](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CustomAlerts/CustomAlerts.php#L114), [ScheduledReports::deletePhoneNumber](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L392)
...
*Defined in [Piwik/Plugins/PrivacyManager/Model/DataSubjects](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php) in line [80](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php#L80)*
...
*Defined in [Piwik/Plugins/PrivacyManager/LogDataPurger](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/LogDataPurger.php) in line [94](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/LogDataPurger.php#L94)*
...
*Defined in [Piwik/Plugins/PrivacyManager/Model/DataSubjects](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php) in line [347](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php#L347)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [536](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L536)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [581](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L581)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [341](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L341)*
...
[CoreHome::initAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L55)
...
*Defined in [Piwik/Tracker/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php) in line [190](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php#L190)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [648](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L648)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [841](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L841)*
...
[MobileMessaging::allowMultipleReports](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L182), [ScheduledReports::allowMultipleReports](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L282)


### ScheduledReports.getRendererInstance

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [471](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L471)*
...
[MobileMessaging::getRendererInstance](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L169), [ScheduledReports::getRendererInstance](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L267)


### ScheduledReports.getReportFormats

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [888](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L888)*
...
[MobileMessaging::getReportFormats](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L155), [ScheduledReports::getReportFormats](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L212)


### ScheduledReports.getReportMetadata

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [813](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L813)*
...
[MobileMessaging::getReportMetadata](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L132), [ScheduledReports::getReportMetadata](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L183)


### ScheduledReports.getReportParameters

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [667](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L667)*
...
[MobileMessaging::getReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L162), [ScheduledReports::getReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L219)


### ScheduledReports.getReportRecipients

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [919](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L919)*
...
[MobileMessaging::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L189), [ScheduledReports::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L434)


### ScheduledReports.getReportTypes

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [864](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L864)*
...
[MobileMessaging::getReportTypes](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L150), [ScheduledReports::getReportTypes](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L207)


### ScheduledReports.processReports

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [449](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L449)*
...
[ScheduledReports::processReports](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L226)


### ScheduledReports.sendReport

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [603](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L603)*
...
[MobileMessaging::sendReport](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L196), [ScheduledReports::sendReport](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L289)


### ScheduledReports.validateReportParameters

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [694](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L694)*
...
[MobileMessaging::validateReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L113), [ScheduledReports::validateReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L139)
...
[ScheduledReports::segmentDeactivation](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L503)
...
[ScheduledReports::segmentUpdated](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L470)
...
[SegmentEditor::getKnownSegmentsToArchiveAllSites](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SegmentEditor/SegmentEditor.php#L66)
...
[SegmentEditor::getKnownSegmentsToArchiveForSite](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SegmentEditor/SegmentEditor.php#L78)
...
[CustomAlerts::deleteAlertsForSite](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CustomAlerts/CustomAlerts.php#L95), [Goals::deleteSiteGoals](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L214), [ScheduledReports::deleteSiteReport](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L118), [SitesManager::onSiteDeleted](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L101), [UsersManager::deleteSite](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L114)
...
*Defined in [Piwik/Plugins/SitesManager/SitesManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php) in line [95](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L95)*
...
[CorePluginsAdmin::addSystemSummaryItems](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CorePluginsAdmin/CorePluginsAdmin.php#L31), [Goals::addSystemSummaryItems](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L95), [SegmentEditor::addSystemSummaryItems](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SegmentEditor/SegmentEditor.php#L52), [SitesManager::addSystemSummaryItems](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L47), [UsersManager::addSystemSummaryItems](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L46)
...
[Goals::fetchGoalsFromDb](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L337), [SitesManager::recordWebsiteDataInCache](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L144), [UsersManager::recordAdminUsersInCache](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L73)
...
*Defined in [Piwik/Tracker/GoalManager](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/GoalManager.php) in line [713](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/GoalManager.php#L713)*
...
*Defined in [Piwik/Tracker/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php) in line [536](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php#L536)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [157](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L157)*
...
[Login::noAccess](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L75)
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [677](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L677)*
...
*Defined in [Piwik/Plugins/UsersManager/UsersManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php) in line [184](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L184)*
...
[ScheduledReports::deleteUserReportForSites](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L535)


### UsersManager.removeSiteAccess

*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [1011](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L1011)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [860](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L860)*
