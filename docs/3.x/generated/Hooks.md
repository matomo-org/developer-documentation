...
[Actions::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/Actions/Actions.php#L49), [Contents::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/Contents/Contents.php#L27), [DevicePlugins::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/DevicePlugins/DevicePlugins.php#L39), [Events::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/Events/Events.php#L40), [Goals::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/Goals/Goals.php#L112), [MultiSites::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/MultiSites/MultiSites.php#L28), [VisitFrequency::addMetricTranslations](https://github.com/piwik/piwik/blob/3.x-dev/plugins/VisitFrequency/VisitFrequency.php#L26)
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [830](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L830)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [463](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L463)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [877](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L877)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [802](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L802)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [656](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L656)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [908](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L908)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [853](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L853)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [441](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L441)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [592](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L592)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [683](https://github.com/piwik/piwik/blob/3.x-dev/plugins/ScheduledReports/API.php#L683)*
...
*Defined in [Piwik/Tracker/Request](https://github.com/piwik/piwik/blob/3.x-dev/core/Tracker/Request.php) in line [518](https://github.com/piwik/piwik/blob/3.x-dev/core/Tracker/Request.php#L518)*
