...
[Goals::getReportMetadataEnd](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L226)
...
[Dashboard::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Dashboard/Dashboard.php#L81), [Goals::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L163)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [558](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L558)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [575](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L575)*
...
*Defined in [Piwik/Plugins/Goals/Goals](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php) in line [319](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L319)*
...
[Goals::addMetrics](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L116)
...
[Plugin::detectIsApiRequest](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/API/API.php#L757), [CoreUpdater::updateCheck](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreUpdater/CoreUpdater.php#L93), [LanguagesManager::initLanguage](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/LanguagesManager/LanguagesManager.php#L94), [UsersManager::onPlatformInitialized](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L58)


### Platform.initialized

*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [395](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L395)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [540](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L540)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [585](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L585)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [652](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L652)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [835](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L835)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [465](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L465)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [882](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L882)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [807](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L807)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [661](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L661)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [913](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L913)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [858](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L858)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [443](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L443)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [597](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L597)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [688](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L688)*
...
*Defined in [Piwik/Plugins/UsersManager/Model](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/Model.php) in line [382](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/Model.php#L382)*
