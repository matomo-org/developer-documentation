...
*Defined in [Piwik/Plugins/Actions/VisitorDetails](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Actions/VisitorDetails.php) in line [233](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Actions/VisitorDetails.php#L233)*
...
[Login::ApiRequestAuthenticate](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L94)
...
*Defined in [Piwik/Tracker/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php) in line [192](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php#L192)*
...
*Defined in [Piwik/Plugins/SitesManager/SitesManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php) in line [98](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/SitesManager/SitesManager.php#L98)*
...
[Goals::fetchGoalsFromDb](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L337), [UsersManager::recordAdminUsersInCache](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L74)
...
*Defined in [Piwik/Tracker/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php) in line [538](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Tracker/Request.php#L538)*
...
[Login::noAccess](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L78)
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [679](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L679)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [1078](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L1078)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [915](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L915)*
