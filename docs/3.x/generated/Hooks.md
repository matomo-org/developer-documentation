...
*Defined in [Piwik/API/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php) in line [377](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php#L377)*
...
[CoreHome::filterMergedJavaScripts](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L78)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [317](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L317)*
...
*Defined in [Piwik/Console](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php) in line [138](https://github.com/matomo-org/matomo/blob/3.x-dev/core/Console.php#L138)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [562](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L562)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [579](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L579)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [490](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L490)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [480](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L480)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [542](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L542)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1160](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1160)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [1559](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L1559)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [363](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L363)*
...
*Defined in [Piwik/CronArchive](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php) in line [321](https://github.com/matomo-org/matomo/blob/3.x-dev/core/CronArchive.php#L321)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [294](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L294)*
...
[PrivacyManager::installationFormInit](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/PrivacyManager.php#L232)
...
[PrivacyManager::installationFormSubmit](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/PrivacyManager.php#L255)
...
*Defined in [Piwik/Plugins/Login/Controller](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Controller.php) in line [380](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Controller.php#L380)*
...
*Defined in [Piwik/Plugins/PrivacyManager/Model/DataSubjects](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php) in line [63](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php#L63)*
...
*Defined in [Piwik/Plugins/PrivacyManager/Model/DataSubjects](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php) in line [299](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/PrivacyManager/Model/DataSubjects.php#L299)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [544](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L544)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [589](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L589)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [332](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L332)*
...
*Defined in [Piwik/API/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php) in line [162](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php#L162)*
...
[CoreHome::initAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CoreHome/CoreHome.php#L45), [Login::initAuthenticationObject](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Login/Login.php#L88)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [364](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L364)*
...
*Defined in [Piwik/API/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php) in line [574](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php#L574)*
...
[MobileMessaging::allowMultipleReports](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L182), [ScheduledReports::allowMultipleReports](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L281)
...
[MobileMessaging::getRendererInstance](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L169), [ScheduledReports::getRendererInstance](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L266)
...
[MobileMessaging::getReportFormats](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L155), [ScheduledReports::getReportFormats](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L211)
...
[MobileMessaging::getReportMetadata](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L132), [ScheduledReports::getReportMetadata](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L182)
...
[MobileMessaging::getReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L162), [ScheduledReports::getReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L218)
...
[MobileMessaging::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L189), [ScheduledReports::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L410)
...
[MobileMessaging::getReportTypes](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L150), [ScheduledReports::getReportTypes](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L206)
...
[MobileMessaging::sendReport](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L196), [ScheduledReports::sendReport](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L288)
...
[MobileMessaging::validateReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L113), [ScheduledReports::validateReportParameters](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L138)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [151](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L151)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [545](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L545)*
...
*Defined in [Piwik/Plugins/UsersManager/UsersManager](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php) in line [179](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/UsersManager.php#L179)*
...
*Defined in [Piwik/Plugins/UsersManager/Model](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/Model.php) in line [319](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/Model.php#L319)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [865](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L865)*
...
*Defined in [Piwik/Plugins/UsersManager/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php) in line [708](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/UsersManager/API.php#L708)*
