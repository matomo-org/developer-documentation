...
*Defined in [Piwik/API/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php) in line [431](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php#L431)*
...
[Dashboard::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Dashboard/Dashboard.php#L90), [Goals::addSubcategories](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/Goals/Goals.php#L164)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [334](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L334)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [311](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L311)*
...
[CustomAlerts::removePhoneNumberFromAllAlerts](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/CustomAlerts/CustomAlerts.php#L114), [ScheduledReports::deletePhoneNumber](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L397)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [399](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L399)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [349](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L349)*
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [656](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L656)*
...
*Defined in [Piwik/API/Request](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php) in line [628](https://github.com/matomo-org/matomo/blob/3.x-dev/core/API/Request.php#L628)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [900](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L900)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [501](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L501)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [947](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L947)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [872](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L872)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [708](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L708)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [978](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L978)*
...
[MobileMessaging::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/MobileMessaging/MobileMessaging.php#L189), [ScheduledReports::getReportRecipients](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L439)


### ScheduledReports.getReportTypes

*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [923](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L923)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [479](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L479)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [644](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L644)*
...
*Defined in [Piwik/Plugins/ScheduledReports/API](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php) in line [735](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/API.php#L735)*
...
[ScheduledReports::segmentDeactivation](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L508)
...
[ScheduledReports::segmentUpdated](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L475)
...
*Defined in [Piwik/FrontController](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php) in line [165](https://github.com/matomo-org/matomo/blob/3.x-dev/core/FrontController.php#L165)*
...
[ScheduledReports::deleteUserReportForSites](https://github.com/matomo-org/matomo/blob/3.x-dev/plugins/ScheduledReports/ScheduledReports.php#L540)
