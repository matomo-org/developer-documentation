...
The developer changelog is located at [https://github.com/matomo-org/matomo/blob/6.x-dev/CHANGELOG.md](https://github.com/matomo-org/matomo/blob/6.x-dev/CHANGELOG.md). If a change
