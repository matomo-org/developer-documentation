...
- [`$export_parameters_to_modify`](#$export_parameters_to_modify) &mdash; An array property that contains query parameter name/value overrides specifically for export links generated by the ViewDataTable UI.
...
An array property that contains query parameter name/value overrides specifically for export
links generated by the ViewDataTable UI.
