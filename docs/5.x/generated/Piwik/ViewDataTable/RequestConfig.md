...
- [`$show_dimensions`](#$show_dimensions) &mdash; If true, dimensions in flattened reports will be added as separate columns
...
<a name="$show_dimensions" id="$show_dimensions"></a>
<a name="show_dimensions" id="show_dimensions"></a>
### `$show_dimensions`
