<small>Piwik\Plugins\AIAgents\Columns\Metrics\</small>

AIAgentMetric
=============

Processed metric for AIAgents.get API method which just copies VisitsSummary.get metrics as differently named metrics.
