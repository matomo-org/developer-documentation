<small>Piwik\Plugins\BotTracking\Columns\Metrics\</small>

DiscrepancyScore
================

Column metadata (name / translation / per-variant documentation / formatting) for the bounded 0–100 Discrepancy Score on the Human/AI-Favoured Pages reports.
