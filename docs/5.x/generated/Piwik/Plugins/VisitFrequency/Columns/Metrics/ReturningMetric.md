<small>Piwik\Plugins\VisitFrequency\Columns\Metrics\</small>

ReturningMetric
===============

Processed metric for VisitFrequency.get API method which just copies VisitsSummary.get metrics as differently named metrics.
