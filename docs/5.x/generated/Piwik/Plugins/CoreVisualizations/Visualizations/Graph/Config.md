...
The properties [$related_reports](/api-reference/Piwik/Plugins/CoreVisualizations/Visualizations/Graph/Config#$related_reports) and [$related_reports_title](/api-reference/Piwik/Plugins/CoreVisualizations/Visualizations/Graph/Config#$related_reports_title) will be overwritten for this purpose.
