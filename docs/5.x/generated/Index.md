...
- [`API`](Piwik/Plugin/API.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`AggregatedMetric`](Piwik/Plugin/AggregatedMetric.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`Archiver`](Piwik/Plugin/Archiver.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`$ARCHIVE_DEPENDENT`](Piwik/Plugin/Archiver.md#$archive_dependent) &mdash; *Property in class* [`Archiver`](Piwik/Plugin/Archiver.md)
...
- [`AIAgentMetric`](Piwik/Plugins/AIAgents/Columns/Metrics/AIAgentMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\AIAgents\Columns\Metrics`- [`AveragePageGenerationTime`](Piwik/Plugins/Actions/Columns/Metrics/AveragePageGenerationTime.md) &mdash; *Class in namespace* `Piwik\Plugins\Actions\Columns\Metrics`- [`AverageTimeOnPage`](Piwik/Plugins/Actions/Columns/Metrics/AverageTimeOnPage.md) &mdash; *Class in namespace* `Piwik\Plugins\Actions\Columns\Metrics`- [`AvgBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/AvgBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`AIChatbotRequests`](Piwik/Plugins/BotTracking/Columns/Metrics/AIChatbotRequests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`AcquiredVisits`](Piwik/Plugins/BotTracking/Columns/Metrics/AcquiredVisits.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`AvgResponseSize`](Piwik/Plugins/BotTracking/Columns/Metrics/AvgResponseSize.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`AvgServerTime`](Piwik/Plugins/BotTracking/Columns/Metrics/AvgServerTime.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`ActionsPerVisit`](Piwik/Plugins/CoreHome/Columns/Metrics/ActionsPerVisit.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreHome\Columns\Metrics`- [`AverageTimeOnSite`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md) &mdash; *Class in namespace* `Piwik\Plugins\CoreHome\Columns\Metrics`- [`afterComputeSubtable()`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md#aftercomputesubtable) &mdash; *Method in class* [`EvolutionMetric`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md)
...
- [`ClickThroughRate`](Piwik/Plugins/BotTracking/Columns/Metrics/ClickThroughRate.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`compute()`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md#compute) &mdash; *Method in class* [`AverageTimeOnSite`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md)
...
- [`$connectedConsentManagers`](Piwik/SiteContentDetector.md#$connectedconsentmanagers) &mdash; *Property in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
- [`clean()`](Piwik/Translation/Translator.md#clean) &mdash; *Method in class* [`Translator`](Piwik/Translation/Translator.md)
- [`createAndListing()`](Piwik/Translation/Translator.md#createandlisting) &mdash; *Method in class* [`Translator`](Piwik/Translation/Translator.md)
- [`createOrListing()`](Piwik/Translation/Translator.md#createorlisting) &mdash; *Method in class* [`Translator`](Piwik/Translation/Translator.md)
...
- [`DownloadBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/DownloadBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`DiscrepancyScore`](Piwik/Plugins/BotTracking/Columns/Metrics/DiscrepancyScore.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`DocumentRequests`](Piwik/Plugins/BotTracking/Columns/Metrics/DocumentRequests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`DevicePlugins`](Piwik/Plugins/DevicePlugins/DevicePlugins.md) &mdash; *Class in namespace* `Piwik\Plugins\DevicePlugins`- [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics`- [`Diagnostic`](Piwik/Plugins/Diagnostics/Diagnostic/Diagnostic.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`DiagnosticResultItem`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResultItem.md) &mdash; *Class in namespace* `Piwik\Plugins\Diagnostics\Diagnostic`- [`Daily`](Piwik/Scheduler/Schedule/Daily.md) &mdash; *Class in namespace* `Piwik\Scheduler\Schedule`- [`$description`](Piwik/Settings/FieldConfig.md#$description) &mdash; *Property in class* [`FieldConfig`](Piwik/Settings/FieldConfig.md)
- [`$detectedContent`](Piwik/SiteContentDetector.md#$detectedcontent) &mdash; *Property in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
- [`detectContent()`](Piwik/SiteContentDetector.md#detectcontent) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
...
- [`fromRequest()`](Piwik/Request.md#fromrequest) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`fromGet()`](Piwik/Request.md#fromget) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`fromPost()`](Piwik/Request.md#frompost) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`fromQueryString()`](Piwik/Request.md#fromquerystring) &mdash; *Method in class* [`Request`](Piwik/Request.md)
...
- [`getCountOfRecordName()`](Piwik/ArchiveProcessor/Record.md#getcountofrecordname) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getCountOfRecordNameIsRecursive()`](Piwik/ArchiveProcessor/Record.md#getcountofrecordnameisrecursive) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getCountOfRecordNameIsForLeafs()`](Piwik/ArchiveProcessor/Record.md#getcountofrecordnameisforleafs) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getColumnToRenameAfterAggregation()`](Piwik/ArchiveProcessor/Record.md#getcolumntorenameafteraggregation) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getBlobColumnAggregationOps()`](Piwik/ArchiveProcessor/Record.md#getblobcolumnaggregationops) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getMultiplePeriodTransform()`](Piwik/ArchiveProcessor/Record.md#getmultipleperiodtransform) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getAggregatedRecordTransform()`](Piwik/ArchiveProcessor/Record.md#getaggregatedrecordtransform) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getBuiltFromFlatRecord()`](Piwik/ArchiveProcessor/Record.md#getbuiltfromflatrecord) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getFlatToHierarchyPathCallback()`](Piwik/ArchiveProcessor/Record.md#getflattohierarchypathcallback) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`getLegacyHierarchyToFlatReducerCallback()`](Piwik/ArchiveProcessor/Record.md#getlegacyhierarchytoflatreducercallback) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
...
- [`getAdditionalKeyColumns()`](Piwik/Columns/Join.md#getadditionalkeycolumns) &mdash; *Method in class* [`Join`](Piwik/Columns/Join.md)
- [`GoalNameJoin`](Piwik/Columns/Join/GoalNameJoin.md) &mdash; *Class in namespace* [`Piwik\Columns\Join`](Piwik/Columns/Join)- [`getAdditionalKeyColumns()`](Piwik/Columns/Join/GoalNameJoin.md#getadditionalkeycolumns) &mdash; *Method in class* [`GoalNameJoin`](Piwik/Columns/Join/GoalNameJoin.md)
- [`getMetrics()`](Piwik/Columns/MetricsList.md#getmetrics) &mdash; *Method in class* [`MetricsList`](Piwik/Columns/MetricsList.md)
...
- [`getLeafRowsCount()`](Piwik/DataTable.md#getleafrowscount) &mdash; *Method in class* [`DataTable`](Piwik/DataTable.md)
...
- [`getDefaultMetricSemanticTypes()`](Piwik/Metrics.md#getdefaultmetricsemantictypes) &mdash; *Method in class* [`Metrics`](Piwik/Metrics.md)
...
- [`getDependentSegmentsToArchive()`](Piwik/Plugin/Archiver.md#getdependentsegmentstoarchive) &mdash; *Method in class* [`Archiver`](Piwik/Plugin/Archiver.md)
...
- [`getSemanticType()`](Piwik/Plugin/Metric.md#getsemantictype) &mdash; *Method in class* [`Metric`](Piwik/Plugin/Metric.md)
...
- [`getMetricSemanticTypes()`](Piwik/Plugin/Report.md#getmetricsemantictypes) &mdash; *Method in class* [`Report`](Piwik/Plugin/Report.md)
...
- [`getNthLevelTableDimension()`](Piwik/Plugin/Report.md#getnthleveltabledimension) &mdash; *Method in class* [`Report`](Piwik/Plugin/Report.md)
...
- [`getSemanticType()`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md#getsemantictype) &mdash; *Method in class* [`AverageTimeOnSite`](Piwik/Plugins/CoreHome/Columns/Metrics/AverageTimeOnSite.md)
...
- [`getSemanticType()`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md#getsemantictype) &mdash; *Method in class* [`EvolutionMetric`](Piwik/Plugins/CoreHome/Columns/Metrics/EvolutionMetric.md)
...
- [`getParameter()`](Piwik/Request.md#getparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getIntegerParameter()`](Piwik/Request.md#getintegerparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getFloatParameter()`](Piwik/Request.md#getfloatparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getStringParameter()`](Piwik/Request.md#getstringparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getBoolParameter()`](Piwik/Request.md#getboolparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getArrayParameter()`](Piwik/Request.md#getarrayparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getJsonParameter()`](Piwik/Request.md#getjsonparameter) &mdash; *Method in class* [`Request`](Piwik/Request.md)
- [`getParameters()`](Piwik/Request.md#getparameters) &mdash; *Method in class* [`Request`](Piwik/Request.md)
...
- [`getSiteContentDetectionsByType()`](Piwik/SiteContentDetector.md#getsitecontentdetectionsbytype) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
- [`getSiteContentDetectionById()`](Piwik/SiteContentDetector.md#getsitecontentdetectionbyid) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
- [`getDetectsByType()`](Piwik/SiteContentDetector.md#getdetectsbytype) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
- [`getKnownConsentManagers()`](Piwik/SiteContentDetector.md#getknownconsentmanagers) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
...
- [`getClientSideComponent()`](Piwik/Widget/WidgetConfig.md#getclientsidecomponent) &mdash; *Method in class* [`WidgetConfig`](Piwik/Widget/WidgetConfig.md)
- [`getClientSideProps()`](Piwik/Widget/WidgetConfig.md#getclientsideprops) &mdash; *Method in class* [`WidgetConfig`](Piwik/Widget/WidgetConfig.md)
...
- [`isCurrentApiRequestNestedInAnotherApiRequest()`](Piwik/API/Request.md#iscurrentapirequestnestedinanotherapirequest) &mdash; *Method in class* [`Request`](Piwik/API/Request.md)
- [`isApiRequest()`](Piwik/API/Request.md#isapirequest) &mdash; *Method in class* [`Request`](Piwik/API/Request.md)
- [`isTokenAuthProvidedSecurely()`](Piwik/API/Request.md#istokenauthprovidedsecurely) &mdash; *Method in class* [`Request`](Piwik/API/Request.md)
...
- [`makeGoalColumnsRow()`](Piwik/Metrics.md#makegoalcolumnsrow) &mdash; *Method in class* [`Metrics`](Piwik/Metrics.md)
...
- [`OverallBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/OverallBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`$overridableProperties`](Piwik/ViewDataTable/Config.md#$overridableproperties) &mdash; *Property in class* [`Config`](Piwik/ViewDataTable/Config.md)
...
- [`PageviewBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/PageviewBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`PageNotFound404Requests`](Piwik/Plugins/BotTracking/Columns/Metrics/PageNotFound404Requests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`PageRequests`](Piwik/Plugins/BotTracking/Columns/Metrics/PageRequests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`ProductConversionRate`](Piwik/Plugins/Goals/Columns/Metrics/ProductConversionRate.md) &mdash; *Class in namespace* `Piwik\Plugins\Goals\Columns\Metrics`- [`ProfileSummaryProvider`](Piwik/Plugins/Live/ProfileSummaryProvider.md) &mdash; *Class in namespace* `Piwik\Plugins\Live`- [`ProfileSummaryAbstract`](Piwik/Plugins/Live/ProfileSummary/ProfileSummaryAbstract.md) &mdash; *Class in namespace* `Piwik\Plugins\Live\ProfileSummary`- [`provideActionsForVisit()`](Piwik/Plugins/Live/VisitorDetailsAbstract.md#provideactionsforvisit) &mdash; *Method in class* [`VisitorDetailsAbstract`](Piwik/Plugins/Live/VisitorDetailsAbstract.md)
...
- [`Requests`](Piwik/Plugins/BotTracking/Columns/Metrics/Requests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`runDiagnostics()`](Piwik/Plugins/Diagnostics/DiagnosticService.md#rundiagnostics) &mdash; *Method in class* [`DiagnosticService`](Piwik/Plugins/Diagnostics/DiagnosticService.md)
...
- [`$RESERVED_SETTING_NAMES`](Piwik/Plugins/TagManager/Template/BaseTemplate.md#$reserved_setting_names) &mdash; *Property in class* [`BaseTemplate`](Piwik/Plugins/TagManager/Template/BaseTemplate.md)
- [`ReturningMetric`](Piwik/Plugins/VisitFrequency/Columns/Metrics/ReturningMetric.md) &mdash; *Class in namespace* `Piwik\Plugins\VisitFrequency\Columns\Metrics`- [`RankingQuery`](Piwik/RankingQuery.md) &mdash; *Class in namespace* `Piwik`- [`ReportWidgetConfig`](Piwik/Report/ReportWidgetConfig.md) &mdash; *Class in namespace* `Piwik\Report`- [`ReportWidgetFactory`](Piwik/Report/ReportWidgetFactory.md) &mdash; *Class in namespace* `Piwik\Report`- [`Request`](Piwik/Request.md) &mdash; *Class in namespace* `Piwik`- [`rescheduleTask()`](Piwik/Scheduler/Scheduler.md#rescheduletask) &mdash; *Method in class* [`Scheduler`](Piwik/Scheduler/Scheduler.md)
...
- [`restrictToDataResponse()`](Piwik/View/SecurityPolicy.md#restricttodataresponse) &mdash; *Method in class* [`SecurityPolicy`](Piwik/View/SecurityPolicy.md)
...
- [`setIsCountOfBlobRecordRows()`](Piwik/ArchiveProcessor/Record.md#setiscountofblobrecordrows) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setIsCountOfBlobRecordLeafRows()`](Piwik/ArchiveProcessor/Record.md#setiscountofblobrecordleafrows) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setColumnToRenameAfterAggregation()`](Piwik/ArchiveProcessor/Record.md#setcolumntorenameafteraggregation) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setBlobColumnAggregationOps()`](Piwik/ArchiveProcessor/Record.md#setblobcolumnaggregationops) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setMultiplePeriodTransform()`](Piwik/ArchiveProcessor/Record.md#setmultipleperiodtransform) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setAggregatedRecordTransform()`](Piwik/ArchiveProcessor/Record.md#setaggregatedrecordtransform) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
- [`setBuiltFromFlatRecord()`](Piwik/ArchiveProcessor/Record.md#setbuiltfromflatrecord) &mdash; *Method in class* [`Record`](Piwik/ArchiveProcessor/Record.md)
...
- [`shiftRow()`](Piwik/DataTable.md#shiftrow) &mdash; *Method in class* [`DataTable`](Piwik/DataTable.md)
...
- [`sumRowWithLabelToSubtable()`](Piwik/DataTable/Row.md#sumrowwithlabeltosubtable) &mdash; *Method in class* [`Row`](Piwik/DataTable/Row.md)
...
- [`SecurityHeaders`](Piwik/Http/SecurityHeaders.md) &mdash; *Class in namespace* [`Piwik\Http`](Piwik/Http)- [`sendForDataResponse()`](Piwik/Http/SecurityHeaders.md#sendfordataresponse) &mdash; *Method in class* [`SecurityHeaders`](Piwik/Http/SecurityHeaders.md)
...
- [`shouldLoadUmdOnDemand()`](Piwik/Plugin.md#shouldloadumdondemand) &mdash; *Method in class* [`Plugin`](Piwik/Plugin.md)
...
- [`SumBandwidth`](Piwik/Plugins/Bandwidth/Columns/Metrics/SumBandwidth.md) &mdash; *Class in namespace* `Piwik\Plugins\Bandwidth\Columns\Metrics`- [`ServerError5xxRequests`](Piwik/Plugins/BotTracking/Columns/Metrics/ServerError5xxRequests.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`singleResult()`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md#singleresult) &mdash; *Method in class* [`DiagnosticResult`](Piwik/Plugins/Diagnostics/Diagnostic/DiagnosticResult.md)
...
- [`SiteContentDetector`](Piwik/SiteContentDetector.md) &mdash; *Class in namespace* `Piwik`- [`setCurrentLanguage()`](Piwik/Translation/Translator.md#setcurrentlanguage) &mdash; *Method in class* [`Translator`](Piwik/Translation/Translator.md)
...
- [`setClientSideComponent()`](Piwik/Widget/WidgetConfig.md#setclientsidecomponent) &mdash; *Method in class* [`WidgetConfig`](Piwik/Widget/WidgetConfig.md)
- [`setClientSideProps()`](Piwik/Widget/WidgetConfig.md#setclientsideprops) &mdash; *Method in class* [`WidgetConfig`](Piwik/Widget/WidgetConfig.md)
...
- [`UniqueHumanPageviews`](Piwik/Plugins/BotTracking/Columns/Metrics/UniqueHumanPageviews.md) &mdash; *Class in namespace* `Piwik\Plugins\BotTracking\Columns\Metrics`- [`update()`](Piwik/Plugins/CustomJsTracker/TrackerUpdater.md#update) &mdash; *Method in class* [`TrackerUpdater`](Piwik/Plugins/CustomJsTracker/TrackerUpdater.md)
...
- [`wasDetected()`](Piwik/SiteContentDetector.md#wasdetected) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
...
- [`__construct()`](Piwik/Plugins/Tour/Engagement/Challenge.md#__construct) &mdash; *Method in class* [`Challenge`](Piwik/Plugins/Tour/Engagement/Challenge.md)
...
- [`__construct()`](Piwik/Request.md#__construct) &mdash; *Method in class* [`Request`](Piwik/Request.md)
...
- [`__construct()`](Piwik/SiteContentDetector.md#__construct) &mdash; *Method in class* [`SiteContentDetector`](Piwik/SiteContentDetector.md)
