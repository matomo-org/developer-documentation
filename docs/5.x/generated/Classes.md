...
- [`ArchiveProcessor\Record`](Piwik/ArchiveProcessor/Record.md)
...
- [`DI`](Piwik/DI.md) &mdash; Proxy class for using DI related methods
...
- [`Plugins\BotTracking\Columns\Metrics\AIChatbotRequests`](Piwik/Plugins/BotTracking/Columns/Metrics/AIChatbotRequests.md) &mdash; Column metric for the AI-chatbot request count on the Human/AI-Favoured Pages reports.
...
- [`Plugins\BotTracking\Columns\Metrics\DiscrepancyScore`](Piwik/Plugins/BotTracking/Columns/Metrics/DiscrepancyScore.md) &mdash; Column metadata (name / translation / per-variant documentation / formatting) for the bounded 0–100 Discrepancy Score on the Human/AI-Favoured Pages reports.
...
- [`Plugins\BotTracking\Columns\Metrics\UniqueHumanPageviews`](Piwik/Plugins/BotTracking/Columns/Metrics/UniqueHumanPageviews.md) &mdash; Column metric for the human-side pageview count on the Human/AI-Favoured Pages reports.
...
- [`Plugins\CoreVisualizations\Visualizations\HtmlTable\Config`](Piwik/Plugins/CoreVisualizations/Visualizations/HtmlTable/Config.md) &mdash; Configuration for the HtmlTable visualization.
...
- [`View`](Piwik/View.md) &mdash; Encapsulates and manages a [Twig](https://twig.sensiolabs.org/) template.
