...
*Defined in [Piwik/Plugins/API/API](https://github.com/matomo-org/matomo/blob/5.x-dev/plugins/API/API.php) in line [710](https://github.com/matomo-org/matomo/blob/5.x-dev/plugins/API/API.php#L710)*
