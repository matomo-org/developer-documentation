...
- [`ControllerAdmin`](Piwik/Plugin/ControllerAdmin.md) &mdash; *Class in namespace* [`Piwik\Plugin`](Piwik/Plugin)- [`ConversionDimension`](Piwik/Plugin/Dimension/ConversionDimension.md) &mdash; *Class in namespace* `Piwik\Plugin\Dimension`- [`configureReportingMenu()`](Piwik/Plugin/Menu.md#configurereportingmenu) &mdash; *Method in class* [`Menu`](Piwik/Plugin/Menu.md)
